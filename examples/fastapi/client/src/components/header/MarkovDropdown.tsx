        ...
        <div className="mt-2 grid grid-cols-1 gap-1">
          {availableModels.map((m) => (
            <button
              ...
              style={{
                backgroundColor: selectedModel === m ? "var(--theme-primary)" : "transparent",
      ...
      <div className="px-4 py-2 space-y-3 border-b overflow-y-auto max-h-[400px]" style={{ borderBottomColor: "var(--theme-border)" }}>
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            onChange={(e) => setGenOptions((p) => ({ ...p, temperature: parseFloat(e.target.value) }))}
            className="w-full h-1 rounded-lg appearance-none cursor-pointer"
            style={{ backgroundColor: "var(--theme-bg)", accentColor: "var(--theme-primary)" }}
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            onChange={(e) => setGenOptions((p) => ({ ...p, top_p: parseFloat(e.target.value) }))}
            className="w-full h-1 rounded-lg appearance-none cursor-pointer"
            style={{ backgroundColor: "var(--theme-bg)", accentColor: "var(--theme-primary)" }}
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            onChange={(e) => setGenOptions((p) => ({ ...p, nGram: parseInt(e.target.value) }))}
            className="w-full h-1 rounded-lg appearance-none cursor-pointer"
            style={{ backgroundColor: "var(--theme-bg)", accentColor: "var(--theme-primary)" }}
          />
        </div>
        ...
        {/* Fractal Section */}
        <div className="pt-2 border-t space-y-3" style={{ borderTopColor: "var(--theme-border)" }}>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) => setGenOptions((p) => ({ ...p, fractalDepth: parseInt(e.target.value) }))}
              className="w-full h-1 rounded-lg appearance-none cursor-pointer"
              style={{ backgroundColor: "var(--theme-bg)", accentColor: "var(--theme-warning)" }}
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) => setGenOptions((p) => ({ ...p, fractalProb: parseFloat(e.target.value) }))}
              className="w-full h-1 rounded-lg appearance-none cursor-pointer"
              style={{ backgroundColor: "var(--theme-bg)", accentColor: "var(--theme-warning)" }}
            />
          </div>
